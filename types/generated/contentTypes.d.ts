...
export interface ApiAccountUserAccountUser extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::newuser.newuser': ApiNewuserNewuser;
